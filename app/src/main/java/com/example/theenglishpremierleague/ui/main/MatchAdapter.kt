...
class MatchAdapter(val fragment: MatchesFragment,private var items: List<MatchEntity>) : RecyclerView.Adapter<MatchAdapter.ViewHolder>() {

    private var isFav: Boolean = false

    class ViewHolder(@NonNull val itemBinding: OneMatchItemBinding) : RecyclerView.ViewHolder(itemBinding.root)
